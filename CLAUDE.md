...
- **★ 信号可信度地图（#150-170 样本外实证审计，单一真相源，禁止再建在已证伪前提上）**：
  - **有 edge（系统真本事=测幅度/极端/形态/逼空，非测温和方向）**：
    · 波动**水平**(rv/HVP/regime) 有真实但**温和短记忆**(#149/#177 ARCH |logret| 自相关 lag-1≈0.28→lag-10≈0.05,null≈0)；
      ⚠️#177 null 对照纠 #153 偏差:原"扩张90%续/rv自相关0.73/lift7.6×"是**滚动窗重叠机械伪影**(null 0.711≈observed 0.725,真实增益+0.014≈0),
      **非"高持续"**;诚实定位=近端弱短记忆可测、非90%续。EWMA 比 rv 更准(#155-159)。脚本 scripts/audit_expansion_persistence.py 可复现。
