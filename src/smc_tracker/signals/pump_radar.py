...
**样本外验证(#162,生产 1H 150币·+15%/12h)**：规则确有真 edge(异于会反转的波动方向信号)——
  RSI>70&ATR%>3 后 P(暴涨)=23.2%/基线1.9%=**lift 12.4×**(略低于声称18×=合理过拟合收缩，仍强)；
  ret24>50%(垂直见顶) 后 P(暴跌)=52.3%/基线0.7%=**lift 71×**(比声称15.8×更强)。
  注：暴涨规则展示的 18× 略乐观于样本外 12.4×；规则方向有效、量级勿当精确承诺。
"""
