...
**样本外验证(#165,1.26万条历史 setup·价格先碰 target1还是 stop)**：谐波系统**经验上盈利**——
整体期望 **+0.5R/笔**(胜率~50% 被有利盈亏比 RR>1 补偿，非靠胜率)。confidence(=比率贴近 Carney 理想度,
1-avg_dev,封顶0.90)**真校准且高端强单调**：conf 0.7→0.8→0.9 期望 +0.20→+0.64→**+1.50R**(0.9桶胜率83%)，
即「比率越紧→越赢」。诚实注:0.6→0.7 小幅非单调(0.7 桶最常见 n=7087 但期望最低+0.20R);Butterfly 形态最弱(胜率45.9%)。
